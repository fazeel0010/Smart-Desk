...
public class FragmentWorkerStep2 extends Fragment implements View.OnClickListener {
    ...
    public FragmentWorkerStep2() {
    }

    public FragmentWorkerStep2(Context mContext) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Constants.const_MechanicSignupDTO.setProfilePicture(null);
    ...
    public void validationsAndGetValues() {
        ScreenWorkerSignup.isOkayStep2 = true;
        if (Constants.const_MechanicSignupDTO.getProfilePicture() == null) {
            ScreenWorkerSignup.isOkayStep2 = false;
        ...
        new Handler().postDelayed(() -> {
            switch (v.getId()) {
                case R.id.take:
                    imageName = "Profile";
                    isCameraOpen = false;
                    if (Constants.const_MechanicSignupDTO.getWorkerPhone() == null) {
                    ...
                    if (Constants.const_MechanicSignupDTO.getProfilePicture() == null) {
                        ...
                        showImageOn(Constants.const_MechanicSignupDTO.getProfilePicture(), "Profile Image");
                    break;
            }
        }, 0);
    }
        ...
        try {
            ...
            alertDialogBuilder.setPositiveButton("GO", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface arg0, int arg1) {
                    ...
                    intent.setData(uri);
                    FragmentWorkerStep2.this.startActivityForResult(intent, PermisionCode.MY_STORAGE_PERMISSION_CODE);
                }
            });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PermisionCode.CAMERA_RESULT_CODE && resultCode == ((Activity) signupContext).RESULT_OK) {
            try {
                ...
                UtilityFunctions.uploadImage((Activity) signupContext, Uri.fromFile(file), imageName, Constants.const_MechanicSignupDTO.getWorkerPhone(), 2);
