...
public class FragmentMechanicRequest extends Fragment {
    ...
    public FragmentMechanicRequest() {
    }

    public FragmentMechanicRequest(Activity context) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_mechanic_request, container, false);
        initIds();
        setRecyclerView();
    ...
    public void showDataOnList(Boolean isSwipe) {
        new Handler().postDelayed(() -> {
            ...
            FirebaseConstants.firebaseFirestore.collection(FirebaseConstants.usersCollection).whereEqualTo("role", Constants.workerRole).whereEqualTo("userStatus", Constants.newAccountStatus).get()
...
//                                redSnackBar(context, "No Internet!", Snackbar.LENGTH_SHORT);
    ...
    public class Adapter extends RecyclerView.Adapter<FragmentMechanicRequest.Adapter.ViewHolder> {
        ...
        @NonNull
        @Override
        public FragmentMechanicRequest.Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            return new FragmentMechanicRequest.Adapter.ViewHolder(view);
        }
        ...
        @Override
        public void onBindViewHolder(@NonNull FragmentMechanicRequest.Adapter.ViewHolder holder, final int position) {
