package com.smartdesk.screens.admin;
...
public class ScreenBlockedMechanics extends AppCompatActivity {
    ...
    ScreenBlockedMechanics.Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.screen_blocked_mechanics);
        context = this;
        initLoadingBarItems();
        actionBar("Blocked Mechanics");
        initIds();
        setRecyclerView();
    }
    ...
    public void showDataOnList(Boolean isSwipe) {
        new Handler().postDelayed(() -> {
            if (!isSwipe)
                startAnim();
            FirebaseConstants.firebaseFirestore.collection(FirebaseConstants.usersCollection).whereEqualTo("role", Constants.workerRole).whereEqualTo("userStatus", Constants.blockedStatus).get().
    ...
    public class Adapter extends RecyclerView.Adapter<ScreenBlockedMechanics.Adapter.ViewHolder> {
